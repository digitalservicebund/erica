...
from src.application.EricRequestProcessing.erica_input.v1.erica_input import UnlockCodeRevocationData
from src.application.EricRequestProcessing.requests_controller import UnlockCodeRevocationRequestController
from src.application.EricaAuftrag.EricaAuftrag import EricaAuftragDto
from src.application.FreischaltCode.FreischaltCode import FreischaltCodeRevocateDto
...
from src.domain.FreischaltCode.FreischaltCode import FreischaltCodeRevocatePayload
