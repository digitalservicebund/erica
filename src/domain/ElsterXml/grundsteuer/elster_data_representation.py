...
from src.application.EricRequestProcessing.erica_input.v2.grundsteuer_input import Anteil, Vertreter, Person, \
    Empfangsbevollmaechtigter, GrundsteuerData, Eigentuemer
from src.domain.ElsterXml.common.basic_xml_data_representation import ENutzdaten, \
    construct_basic_xml_data_representation
from src.domain.ElsterXml.common.elsterify_fields import elsterify_anrede, elsterify_date
