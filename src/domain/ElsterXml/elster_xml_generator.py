...
from src.domain.ElsterXml.elster_xml_tree import TOP_ELEMENT_ESTA1A, TOP_ELEMENT_SA, TOP_ELEMENT_AGB, TOP_ELEMENT_HA35A, \
    TOP_ELEMENT_VOR, ElsterXmlTreeNode
from src.domain.ElsterXml.est_mapping import PersonSpecificFieldId
from src.domain.ElsterXml.transfer_header_fields import get_est_th_fields, get_vast_request_th_fields, \
