...
from src.erica_legacy.api.v1.endpoints import ping
from src.erica_legacy.api.v1.endpoints.rente import tax, est, address, unlock_code
from src.erica_legacy.api.v1.endpoints.grundsteuer import grundsteuer
