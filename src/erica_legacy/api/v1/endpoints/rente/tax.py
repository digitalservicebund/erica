...
from src.erica_legacy.request_processing.requests_controller import CheckTaxNumberRequestController
...
def get_tax_offices():
    ...
    """
    return FileResponse("src/erica_legacy/static/tax_offices.json")
