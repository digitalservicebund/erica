...
from src.erica_legacy.api.v2.endpoints import ping
from src.erica_legacy.api.v2.endpoints.rente import fsc, est, tax
from src.erica_legacy.api.v2.endpoints.grundsteuer import grundsteuer
