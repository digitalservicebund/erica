...
from src.erica_legacy.api.v2.responses.model import response_model_get_tax_number_validity_from_queue
from src.erica_legacy.pyeric.utils import generate_dummy_error_response
from src.erica_legacy.request_processing.erica_input.v2.erica_input import TaxValidityWithTtl, ErrorRequestQueue
...
def get_tax_offices():
    ...
    """
    return FileResponse("src/erica_legacy/tax_offices.json")
