...
from erica.erica_api.dto.grundsteuer_input_eigentuemer import Person, Eigentuemer, PersoenlicheAngaben, \
    Adresse, Anteil
from tests.erica_worker.samples.grundsteuer_sample_data import SamplePerson
