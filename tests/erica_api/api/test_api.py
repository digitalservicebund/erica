...
from erica.erica_api.api.v2.endpoints.est import send_est, get_send_est_job
from erica.erica_api.api.v2.endpoints.fsc import request_fsc, get_fsc_request_job, activate_fsc, get_fsc_activation_job, \
    revocate_fsc, get_fsc_revocation_job
from erica.erica_api.api.v2.endpoints.grundsteuer import send_grundsteuer, get_grundsteuer_job
from erica.erica_api.api.v2.endpoints.tax import is_valid_tax_number, get_valid_tax_number_job
from erica.erica_api.service.freischaltcode_service import FreischaltCodeService
from erica.erica_shared.job_service.job_service import JobService
from erica.erica_api.dto.response_dto import JobState
from erica.erica_api.dto.erica_request_dto import EricaRequestDto
from erica.erica_api.service.grundsteuer_service import GrundsteuerService
from erica.erica_api.service.tax_declaration_service import TaxDeclarationService
from erica.erica_api.service.tax_number_validition_service import TaxNumberValidityService
from erica.erica_shared.model.erica_request import EricaRequest, RequestType, Status
from tests.erica_api.service.test_job_service import MockEricaRequestRepository, MockRequestController, MockDto, \
    PickableMock
...
async def test_if_get_fsc_request_or_activation_job_returns_success_status_with_result(api_method, request_type):
    ...
    with patch("erica.erica_api.api.v2.endpoints.fsc.get_service", MagicMock()) as get_service_mock:
...
async def test_if_get_tax_validity_job_returns_success_status_with_result():
    ...
    erica_request = EricaRequest(type=RequestType.check_tax_number, status=Status.success,
                                 ...
                                 request_id=request_id, creator_id="test")
    with patch("erica.erica_api.api.v2.endpoints.tax.get_service", MagicMock()) as get_service_mock:
        mock_service = MagicMock(get_request_by_request_id=MagicMock(return_value=erica_request))
...
async def test_if_get_send_est_job_returns_success_status_with_result():
    ...
    erica_request = EricaRequest(type=RequestType.send_est, status=Status.success,
                                 ...
                                 request_id=request_id, creator_id="test")
    with patch("erica.erica_api.api.v2.endpoints.est.get_service", MagicMock()) as get_service_mock:
        mock_service = MagicMock(get_request_by_request_id=MagicMock(return_value=erica_request))
...
async def test_if_get_grundsteuer_job_returns_success_status_with_result():
    ...
    erica_request = EricaRequest(type=RequestType.grundsteuer, status=Status.success,
                                 ...
                                 result={"transferticket": transferticket, "pdf": pdf},
                                 request_id=request_id, creator_id="test")
    with patch("erica.erica_api.api.v2.endpoints.grundsteuer.get_service", MagicMock()) as get_service_mock:
        mock_service = MagicMock(get_request_by_request_id=MagicMock(return_value=erica_request))
