...
class TestEEmpfangsbevollmaechtigter:
    ...
    def test_if_no_bruchteilsgemeinschaft_set_flag_to_none(self):
        ...
        with patch('erica.worker.elster_xml.common.elsterify_fields.elsterify_eigentumsverhaeltnis',
    ...
    def test_if_bruchteilsgemeinschaft_set_flag_to_1(self):
        ...
        with patch('erica.worker.elster_xml.grundsteuer.elster_eigentuemer.elsterify_eigentumsverhaeltnis',
