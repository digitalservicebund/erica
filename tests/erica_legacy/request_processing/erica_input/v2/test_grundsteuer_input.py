...
from erica.erica_legacy.request_processing.erica_input.v2.grundsteuer_input_eigentuemer import SteuerId, Verheiratet, Person, \
    Eigentuemer
from erica.erica_legacy.request_processing.erica_input.v2.grundsteuer_input_gebaeude import Ab1949, Kernsaniert, \
    Abbruchverpflichtung, WeitereWohnraeume, WeitereWohnraeumeDetails, Garagen, GaragenAnzahl, Gebaeude
from tests.erica_legacy.samples.grundsteuer_sample_data import get_sample_single_person_dict, SampleGebaeude
