...
class TestGebaeude:
    ...
    def test_if_neither_wohnflaeche_nor_wohnflaechen_then_raise_error(self):
        gebaeude = SampleGebaeude().build()

        with pytest.raises(ValidationError):
            Gebaeude.parse_obj(gebaeude)

    def test_if_both_wohnflaeche_and_wohnflaechen_then_raise_error(self):
        gebaeude = SampleGebaeude().with_wohnflaeche(1).with_wohnflaechen(2, 3).build()

        with pytest.raises(ValidationError):
            Gebaeude.parse_obj(gebaeude)

    def test_if_only_wohnflaeche_then_parse_successfully(self):
    ...
    def test_if_only_wohnflaechen_then_parse_successfully(self):
