...
from src.erica_legacy.request_processing.grundsteuer_request_controller import GrundsteuerRequestController
from tests.erica_legacy.samples.grundsteuer_sample_data import get_grundsteuer_sample_data
from tests.erica_legacy.samples.grundsteuer_sample_input import grundsteuer_sample_input
...
class TestGenerateJson:
    def test_result_includes_all_relevant_aspects(self, valid_grundsteuer_request_controller):
        ...
        with patch('src.erica_legacy.request_processing.requests_controller.get_transfer_ticket_from_xml', MagicMock(return_value='transfer ticket')):
