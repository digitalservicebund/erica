...
from tests.erica_legacy.utils import missing_cert, missing_pyeric_lib, TEST_EST_VERANLAGUNGSJAHR
...
class TestEstPyericControllerGetEricResponse(unittest.TestCase):
    ...
    def setUp(self):
        with open('tests/erica_legacy/elster_xml/sample_with_auth.xml', 'r') as f:
            self.correct_input_xml = f.read()
        with open('tests/erica_legacy/elster_xml/unsuccesful_sample.xml', 'r') as f:
