...
from erica.erica_api.dto.grundsteuer_input_eigentuemer import Anrede
from erica.erica_api.dto.grundsteuer_input_grundstueck import Grundstuecksart
from tests.erica_worker.samples.grundsteuer_sample_data import SampleEigentuemer, SamplePerson
