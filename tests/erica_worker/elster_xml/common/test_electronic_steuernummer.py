...
from tests.erica_worker.utils import missing_pyeric_lib
...
class TestGetBufaNrFromSteuernummer:
    ...
    def test_calls_steuernummer_generation(self):
        with patch("erica.erica_worker.elster_xml.common.electronic_steuernummer.generate_electronic_steuernummer") as fun_gen_steuernummer:
