...
from erica.erica_worker.elster_xml.grundsteuer.elster_eigentuemer import EAnteil, EGesetzlicherVertreter, EPersonData, \
    EEigentumsverh, EEmpfangsbevollmaechtigter
from erica.erica_api.dto.grundsteuer_input_eigentuemer import Anteil, Eigentuemer
from tests.erica_worker.samples.grundsteuer_sample_data import SampleVertreter, SampleBevollmaechtigter, SamplePerson, \
...
class TestEEmpfangsbevollmaechtigter:
    ...
    def test_if_no_bruchteilsgemeinschaft_set_flag_to_none(self):
        ...
        with patch('erica.erica_worker.elster_xml.common.elsterify_fields.elsterify_eigentumsverhaeltnis',
    ...
    def test_if_bruchteilsgemeinschaft_set_flag_to_1(self):
        ...
        with patch('erica.erica_worker.elster_xml.grundsteuer.elster_eigentuemer.elsterify_eigentumsverhaeltnis',
