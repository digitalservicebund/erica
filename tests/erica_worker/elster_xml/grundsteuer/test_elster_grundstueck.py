from erica.erica_worker.elster_xml.common.elsterify_fields import elsterify_grundstuecksart, \
    elsterify_wirtschaftliche_einheit_zaehler
from erica.erica_worker.elster_xml.grundsteuer.elster_grundstueck import ELage, EMehrereGemeinden, EFlurstueck, \
...
from tests.erica_worker.samples.grundsteuer_sample_data import SampleGrundstueck, SampleFlurstueck
