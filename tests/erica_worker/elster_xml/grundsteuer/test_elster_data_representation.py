...
from erica.erica_worker.elster_xml.common.basic_xml_data_representation import EXml
from erica.erica_worker.elster_xml.common.xml_conversion import convert_object_to_xml
from erica.erica_worker.elster_xml.grundsteuer.elster_data_representation import ERueckuebermittlung, EVorsatz, \
...
from erica.erica_worker.elster_xml.grundsteuer.elster_eigentuemer import EPersonData, EEigentumsverh, \
    EEmpfangsbevollmaechtigter
from erica.erica_worker.elster_xml.grundsteuer.elster_gebaeude import EAngWohn
from erica.erica_worker.elster_xml.grundsteuer.elster_grundstueck import ELage, EAngGrundstuecksart, EMehrereGemeinden, \
...
from tests.erica_worker.samples.grundsteuer_sample_data import SampleGrundstueck, SampleBevollmaechtigter, SamplePerson, \
    SampleEigentuemer, \
