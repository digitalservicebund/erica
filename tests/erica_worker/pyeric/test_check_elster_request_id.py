...
from erica.erica_worker.pyeric.check_elster_request_id import get_vast_list_from_xml, get_list_vast_requests, \
...
class TestRequestNeedsTestmerker:
    ...
    def test_if_idnr_in_list_then_cache_invalidated(self):
        ...
        with patch('erica.erica_worker.pyeric.check_elster_request_id.get_list_vast_requests') as get_list_vast_requests_mock:
