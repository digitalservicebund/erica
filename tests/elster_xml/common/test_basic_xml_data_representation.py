...
from erica.elster_xml.common.basic_xml_data_representation import EEmpfaenger, ENutzdatenHeader, ENutzdaten, \
...
@pytest.fixture
def default_function_args(nutzdaten):
...
class TestENutzdatenblock:
    def test_attributes_set_correctly(self, nutzdaten, default_function_args):
...
class TestConstructBasicXmlDataRepresentation:
    ...
    def test_returns_correct_object(self, default_function_args):
        resulting_object = construct_basic_xml_data_representation(*default_function_args)
        assert resulting_object == EXml(*default_function_args)
    ...
    def test_returns_an_object_convertable_to_valid_xml(self, default_function_args):
        resulting_object = construct_basic_xml_data_representation(*default_function_args)
