...
response_model_post_to_queue = {
    ...
    422: {"model": ResponseErrorDto, "description": "Job could not be submitted to the queue."},
    500: {"model": ResponseErrorDto, "description": "Job could not be submitted to the queue."}}
