...
from erica.erica_legacy.api.v2.endpoints import ping
from erica.erica_legacy.api.v2.endpoints.rente import fsc, est, tax
from erica.erica_legacy.api.v2.endpoints.grundsteuer import grundsteuer
