...
class Settings(BaseSettings):
    ...
    cert_path: str = 'erica/erica_legacy/instances/blueprint/cert.pfx'
    ...
    def get_eric_dll_path():
        if platform == "darwin":
            return "erica/erica_legacy/lib/libericapi.dylib"
        else:
            return "erica/erica_legacy/lib/libericapi.so"
