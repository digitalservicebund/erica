...
ERIC_ERROR_MESSAGES = {**_ERIC_SUCCESS_CODE, **_ERIC_CUSTOM_ERROR_CODES, **_ERIC_GLOBAL_VALIDATION_ERRORS,
...
ERIC_ERRORS_WITH_RETRY = ["ERIC_CRYPT_E_SC_SLOT_EMPTY", "ERIC_CRYPT_E_P11_SLOT_EMPTY", "ERIC_TRANSFER_ERR_PROXYCONNECT",
                          ...
                          "ERIC_TRANSFER_COM_ERROR", "ERIC_TRANSFER_ERR_ENDDATENGROESSE",
...
class EricProcessNotSuccessful(Exception):
    ...
    def get_eric_error_code_message(res_code):
        return ERIC_ERROR_MESSAGES.get(res_code, "UNKNOWN_ERROR")
