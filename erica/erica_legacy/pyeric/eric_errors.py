...
_ERIC_ERRORS_NO_RETRY = ["ALREADY_OPEN_UNLOCK_CODE_REQUEST", "ELSTER_REQUEST_ID_UNKNOWN", "ERIC_GLOBAL_PRUEF_FEHLER",
                         "ERIC_GLOBAL_LANDESNUMMER_UNBEKANNT",
                         "ERIC_GLOBAL_BUFANR_UNBEKANNT", "ERIC_GLOBAL_LANDESNUMMER_BUFANR",
                         "ERIC_GLOBAL_LANDESNUMMER_BUFANR", "NO_MATCHING_IDENTIFIER_FOR_UNLOCK_REQUEST",
                         "ERIC_TRANSFER_ERR_DATENTEILFEHLER", "ERIC_IO_UNGUELTIGE_ZEICHEN_IN_PARAMETER",
                         "INVALID_BUFA_NUMBER", "INVALID_TAX_NUMBER",
                         "ERIC_GLOBAL_PRUEF_FEHLER", "ERIC_GLOBAL_STEUERNUMMER_UNGUELTIG", "ERIC_GLOBAL_UNKNOWN",
                         "ERIC_GLOBAL_HINWEISE",
                         "ERIC_GLOBAL_DATENSATZ_ZU_GROSS", "ERIC_GLOBAL_STEUERNUMMER_FALSCHE_LAENGE",
                         "ERIC_GLOBAL_STEUERNUMMER_NICHT_NUMERISCH",
                         "ERIC_GLOBAL_IDNUMMER_UNGUELTIG", "ERIC_CRYPT_E_INVALID_HANDLE", "ERIC_CRYPT_E_DECRYPT",
                         "ERIC_CRYPT_E_ENCODE_ERROR", "ERIC_CRYPT_E_ENCODE_UNKNOWN", "ERIC_CRYPT_E_ENCRYPT",
                         "ERIC_CRYPT_E_PIN_WRONG", "ERIC_CRYPT_E_XML_INIT", "ERIC_CRYPT_E_XML_PARSE",
                         "ERIC_CRYPT_E_XML_SIG_TAG", "ERIC_CRYPT_PIN_BENOETIGT",
                         "ERIC_CRYPT_PIN_ENTHAELT_UNGUELTIGE_ZEICHEN", "ERIC_CRYPT_ZERTIFIKATSPFAD_KEIN_VERZEICHNIS",
                         "ERIC_GLOBAL_ABRUFCODE_NICHT_ERLAUBT", "ERIC_GLOBAL_BUNDESLAENDER_UNEINHEITLICH",
                         "ERIC_GLOBAL_CHECK_CORRUPTED_NDS", "ERIC_GLOBAL_COMMONDATA_NICHT_VERFUEGBAR",
                         "ERIC_GLOBAL_DATENARTVERSION_UNBEKANNT", "ERIC_GLOBAL_DATENARTVERSION_XML_INKONSISTENT",
                         "ERIC_GLOBAL_DRUCK_FUER_VERFAHREN_NICHT_ERLAUBT", "ERIC_GLOBAL_ECHTFALL_NICHT_ERLAUBT",
                         "ERIC_GLOBAL_EINSTELLUNG_NAME_UNGUELTIG", "ERIC_GLOBAL_EINSTELLUNG_WERT_UNGUELTIG",
                         "ERIC_GLOBAL_ERROR_XML_CREATE", "ERIC_GLOBAL_ERSTE_SEITE_DRUCK_NICHT_UNTERSTUETZT",
                         "ERIC_GLOBAL_FEHLER_INITIALISIERUNG", "ERIC_GLOBAL_FEHLERMELDUNG_NICHT_VORHANDEN",
                         "ERIC_GLOBAL_FUNKTION_NICHT_ERLAUBT", "ERIC_GLOBAL_FUNKTION_NICHT_UNTERSTUETZT",
                         "ERIC_GLOBAL_HERSTELLER_ID_NICHT_ERLAUBT", "ERIC_GLOBAL_ILLEGAL_STATE",
                         "ERIC_GLOBAL_KEINE_DATEN_VORHANDEN", "ERIC_GLOBAL_MEHRFACHAUFRUFE_NICHT_UNTERSTUETZT",
                         "ERIC_GLOBAL_MEHRFACHE_INITIALISIERUNG", "ERIC_GLOBAL_NICHT_INITIALISIERT",
                         "ERIC_GLOBAL_NULL_PARAMETER", "ERIC_GLOBAL_NUR_PORTALZERTIFIKAT_ERLAUBT",
                         ...
                         "ERIC_GLOBAL_OEFFENTLICHER_SCHLUESSEL_UNGUELTIG", "ERIC_GLOBAL_PLUGININITIALISIERUNG",
                         "ERIC_GLOBAL_PUFFER_UEBERLAUF", "ERIC_GLOBAL_PUFFER_UNGLEICHER_INSTANZ",
                         "ERIC_GLOBAL_PUFFER_ZUGRIFFSKONFLIKT", "ERIC_GLOBAL_SEND_FLAG_MEHR_ALS_EINES",
                         "ERIC_GLOBAL_TESTMERKER_UNGUELTIG", "ERIC_GLOBAL_TEXTPUFFERGROESSE_FIX",
                         "ERIC_GLOBAL_TRANSFERHANDLE", "ERIC_GLOBAL_TRANSPORTSCHLUESSEL_NICHT_ERLAUBT",
                         "ERIC_GLOBAL_TRANSPORTSCHLUESSEL_TYP_FALSCH", "ERIC_GLOBAL_UNGUELTIGE_FLAG_KOMBINATION",
                         "ERIC_GLOBAL_UNGUELTIGE_INSTANZ", "ERIC_GLOBAL_UNGUELTIGE_PARAMETER_VERSION",
                         "ERIC_GLOBAL_UNGUELTIGER_PARAMETER", "ERIC_GLOBAL_UNKNOWN_PARAMETER_ERROR",
                         "ERIC_GLOBAL_UTI_COUNTRY_NOT_SUPPORTED", "ERIC_GLOBAL_VERSAND_ART_NICHT_UNTERSTUETZT",
                         "ERIC_GLOBAL_VERSCHLUESSELUNGS_PARAMETER_NICHT_ANGEGEBEN",
                         "ERIC_GLOBAL_VERSCHLUESSELUNGS_PARAMETER_NICHT_ERLAUBT",
                         "ERIC_GLOBAL_VERSCHLUESSELUNGSVERFAHREN_NICHT_UNTERSTUETZT", "ERIC_GLOBAL_VORSATZ_UNGUELTIG",
                         "ERIC_GLOBAL_ZEITRAEUME_UNEINHEITLICH", "ERIC_IO_DATEI_INKORREKT",
                         "ERIC_IO_DATENTEILENDNOTFOUND", "ERIC_IO_DATENTEILNOTFOUND", "ERIC_IO_FEHLER",
                         "ERIC_IO_NDS_GENERIERUNG_FEHLGESCHLAGEN", "ERIC_IO_PARSE_FEHLER",
                         "ERIC_IO_READER_FALSCHES_ENCODING", "ERIC_IO_READER_FORMALE_FEHLER",
                         "ERIC_IO_READER_MEHRFACHE_NUTZDATEN_ELEMENTE",
                         "ERIC_IO_READER_MEHRFACHE_NUTZDATENBLOCK_ELEMENTE", "ERIC_IO_READER_MEHRFACHE_STEUERFAELLE",
                         "ERIC_IO_READER_SCHEMA_VALIDIERUNGSFEHLER", "ERIC_IO_READER_STEUERZEICHEN_IM_NUTZDATENHEADER",
                         "ERIC_IO_READER_STEUERZEICHEN_IM_TRANSFERHEADER",
                         "ERIC_IO_READER_STEUERZEICHEN_IN_DEN_NUTZDATEN", "ERIC_IO_READER_UNBEKANNTE_XML_ENTITY",
                         "ERIC_IO_READER_UNERWARTETE_ELEMENTE", "ERIC_IO_READER_UNTERSACHBEREICH_UNGUELTIG",
                         "ERIC_IO_READER_ZU_VIELE_NUTZDATENBLOCK_ELEMENTE", "ERIC_IO_STEUERZEICHEN_IM_NDS",
                         "ERIC_IO_UEBERGABEPARAMETER_FEHLERHAFT", "ERIC_IO_UNBEKANNTE_DATENART",
                         "ERIC_IO_UNGUELTIGE_UTF8_SEQUENZ", "ERIC_TRANSFER_ERR_BEGINDATENGROESSE",
                         "ERIC_TRANSFER_ERR_BEGINDATENLIEFERANT", "ERIC_TRANSFER_ERR_BEGINTRANSPORTSCHLUESSEL",
                         "ERIC_TRANSFER_ERR_DATENTEILENDNOTFOUND", "ERIC_TRANSFER_ERR_ENDDATENLIEFERANT",
                         "ERIC_TRANSFER_ERR_ENDSIGUSER", "ERIC_TRANSFER_ERR_ENDTRANSPORTSCHLUESSEL",
                         "ERIC_TRANSFER_ERR_PARAM", "ERIC_TRANSFER_ERR_PROXYAUTH",
                         "ERIC_TRANSFER_ERR_PROXYPORT_INVALID", "ERIC_TRANSFER_ERR_XML_ENCODING",
                         "ERIC_TRANSFER_ERR_XML_NHEADER ", "ERIC_TRANSFER_ERR_XML_THEADER",
                         "ERIC_TRANSFER_ERR_XMLTAG_NICHT_GEFUNDEN", "ERIC_TRANSFER_VORGANG_NICHT_UNTERSTUETZT",
                         "ERIC_CRYPT_CORRUPTED", "ERIC_CRYPT_E_ESICL_EXCEPTION", "ERIC_CRYPT_E_INTERN",
                         "ERIC_CRYPT_E_INVALID_PARAM_ABC", "ERIC_CRYPT_E_MAX_SESSION", "ERIC_CRYPT_E_NO_SERVICE",
                         "ERIC_CRYPT_E_NO_SIG_ENC_KEY", "ERIC_CRYPT_E_OUT_OF_MEM", "ERIC_CRYPT_E_P11_ENC_KEY",
                         "ERIC_CRYPT_E_P11_ENGINE_LOADED", "ERIC_CRYPT_E_P11_INIT_FAILED",
                         "ERIC_CRYPT_E_P11_NO_ENC_CERT", "ERIC_CRYPT_E_P11_NO_SIG_CERT", "ERIC_CRYPT_E_P11_SIG_KEY",
                         "ERIC_CRYPT_E_P12_CREATE", "ERIC_CRYPT_E_P12_DECODE", "ERIC_CRYPT_E_P12_ENC_KEY",
                         "ERIC_CRYPT_E_P12_NO_ENC_CERT", "ERIC_CRYPT_E_P12_NO_SIG_CERT", "ERIC_CRYPT_E_P12_READ",
                         "ERIC_CRYPT_E_P12_SIG_KEY", "ERIC_CRYPT_E_P7_DECODE", "ERIC_CRYPT_E_P7_READ",
                         "ERIC_CRYPT_E_P7_RECIPIENT", "ERIC_CRYPT_E_PIN_LOCKED", "ERIC_CRYPT_E_SC_ENC_KEY",
                         "ERIC_CRYPT_E_SC_INIT_FAILED", "ERIC_CRYPT_E_SC_NO_APPLET", "ERIC_CRYPT_E_SC_NO_ENC_CERT",
                         "ERIC_CRYPT_E_SC_NO_SIG_CERT", "ERIC_CRYPT_E_SC_SESSION", "ERIC_CRYPT_E_SC_SIG_KEY",
                         "ERIC_CRYPT_E_TOKEN_TYPE_MISMATCH", "ERIC_CRYPT_E_USER_CANCEL",
                         "ERIC_CRYPT_E_VERIFY_CERT_CHAIN", "ERIC_CRYPT_E_XML_SIG_ADD", "ERIC_CRYPT_E_XML_SIG_SIGN",
                         "ERIC_CRYPT_EIDKARTE_NICHT_UNTERSTUETZT", "ERIC_CRYPT_ERROR_CREATE_KEY",
                         "ERIC_CRYPT_NICHT_UNTERSTUETZTES_PSE_FORMAT", "ERIC_CRYPT_PIN_STAERKE_NICHT_AUSREICHEND",
                         "ERIC_CRYPT_SIGNATUR", "ERIC_CRYPT_ZERTIFIKAT",
                         "ERIC_CRYPT_ZERTIFIKATSDATEI_EXISTIERT_BEREITS", "ERIC_GLOBAL_ARITHMETIKFEHLER",
                         "ERIC_GLOBAL_DATEI_NICHT_GEFUNDEN", "ERIC_GLOBAL_DATEIZUGRIFF_VERWEIGERT",
                         "ERIC_GLOBAL_ERR_DEKODIEREN", "ERIC_GLOBAL_INKOMPATIBLE_VERSIONEN",
                         "ERIC_GLOBAL_INTERNER_FEHLER", "ERIC_GLOBAL_LOG_EXCEPTION",
                         "ERIC_GLOBAL_NICHT_GENUEGEND_ARBEITSSPEICHER", "ERIC_GLOBAL_NO_VERSAND_IN_BETA_VERSION",
                         "ERIC_GLOBAL_UNKNOWN_PARAMETER_ERROR", "ERIC_GLOBAL_UPDATE_NECESSARY",
                         "ERIC_IO_FALSCHES_VERFAHREN", "ERIC_IO_MASTERDATENSERVICE_NICHT_VERFUEGBAR",
                         "ERIC_IO_VERSIONSINFORMATIONEN_NICHT_GEFUNDEN", "ERIC_TRANSFER_ERR_OTHER",
                         "ERIC_TRANSFER_ERR_SEND", "ERIC_TRANSFER_ERR_SEND_INIT"]
