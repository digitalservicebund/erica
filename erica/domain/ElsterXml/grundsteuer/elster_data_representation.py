...
from erica.application.EricRequestProcessing.erica_input.v2.grundsteuer_input import Anteil, Vertreter, Person, \
    Empfangsbevollmaechtigter, GrundsteuerData, Eigentuemer
from erica.domain.ElsterXml.common.basic_xml_data_representation import ENutzdaten, \
    construct_basic_xml_data_representation
from erica.domain.ElsterXml.common.elsterify_fields import elsterify_anrede, elsterify_date
...
class EEigentumsverh:
    ...
    def __init__(self, input_data: Eigentuemer):
