from erica.domain.ElsterXml.xml_parsing.erica_xml_parsing import get_elements_from_xml, \
    get_elements_text_from_xml_element, _get_element_from_xml, remove_declaration_and_namespace
